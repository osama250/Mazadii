<div class="table-responsive-sm">
    <table class="table table-striped" id="faqs-table">
        <thead>
            <tr>
                <th>@lang('models/fags.fields.id')</th>
                {{-- <th>@lang('models/fags.fields.language')</th> --}}
                <th>@lang('models/fags.fields.name')</th>
                <th>@lang('models/fags.fields.answer')</th>
                <th>@lang('models/fags.fields.action')</th>
            </tr>
        </thead>
        <tbody>
            @foreach($faqs as $faq)
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        ...
                        @endcan
                        @can('faqs edit')
                        <a href="{{ route('adminPanel.faqs.edit', [$faq->id]) }}" class='btn btn-ghost-info'>
