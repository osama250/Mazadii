        ...
        <ul class="nav nav-pills mb-1" id="pills-tab" role="tablist">
            ...
            @foreach ( config('langs') as $locale => $name)
                <li class="nav-item">
                    ...
                    aria-selected="{{ request('languages') == $locale  ? 'true' : 'false'}}">{{$name}}
                    </a> --}}
                ...
                <div class="tab-pane fade {{$i?'show active':''}}" id="{{$name}}" id="{{$name}}" role="tabpanel" aria-labelledby="{{$name}}-tab">
                    <!-- Title Field -->
                        <div class="form-group col-sm-6">
                            ...
                            {!! Form::text($locale . '[title]', isset($meta)? $meta->translateOrNew($locale)->title : '' , ['class'
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            {!! Form::textarea($locale . '[description]', isset($meta)? $meta->translateOrNew($locale)->description :
