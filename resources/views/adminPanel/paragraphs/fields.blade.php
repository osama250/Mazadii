<div class="row">
    <div class="col nav-tabs-boxed">
        ...
        <ul class="nav nav-pills mb-1" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->filled('lang')? request('lang') == $name ?'show active':'' : $i?'active':''}}" id="{{$name}}-tab" data-toggle="pill" href="#{{$name}}"
                    role="tab" aria-controls="{{$name}}" aria-selected="{{request()->filled('lang')? request('lang') == $name ?'show active':'' : $i ? 'true' : 'false'}}">{{$name}}</a>
            </li>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade {{request()->filled('lang')? request('lang') == $name ?'show active':'' : $i?'show active':''}}" id="{{$name}}" role="tabpanel"
